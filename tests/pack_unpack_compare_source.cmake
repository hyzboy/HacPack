...
set(STAGE_DIR "${BUILD_DIR}/hacpack_test_source_roundtrip")
set(UNPACK_DIR "${BUILD_DIR}/hacpack_test_unpacked")
...
execute_process(
    COMMAND "${HACPACK_EXE}" unpack "${OUTPUT_PACK}" "${UNPACK_DIR}"
...
if(NOT UNPACK_RESULT EQUAL 0)
    message(FATAL_ERROR "Unpack step failed (code=${UNPACK_RESULT})\nSTDOUT:\n${UNPACK_STDOUT}\nSTDERR:\n${UNPACK_STDERR}")
endif()

execute_process(
    COMMAND "${HACPACK_EXE}" compare "${OUTPUT_PACK}" "${UNPACK_DIR}"
...
message(STATUS "HacPack roundtrip pack/unpack/compare test passed")
